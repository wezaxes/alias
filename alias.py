        ...
        if is_host:
            if st.button("ПОЧАТИ ГРУ 🎲"):
                ...
                if len(players) >= 2:
                    ...
                    st.error("Ты нарушал обещание,чёрт тайлер что здесь происходит почему меня принимают за тебя?!
Сядь,Так почему меня принимают за тебя? А ты не знаешь?нет не знаю, нет знаешь, нет,нет ... Я не знаю, вспомни,почему все вокруг путают нас? Потому что, потому что....Потому что мы одни человек?
Правильно. ")
        else:
