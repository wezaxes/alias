...
# --- СИНХРОНІЗОВАНЕ ЛОББІ (DISCORD) ---
    ...
    if is_host:
        ...
        # Додано value=, щоб підтягувати актуальне значення з бази
        h_rounds = st.number_input("Кількість раундів", 1, 20, value=data.get("total_rounds", 3))
        h_timer = st.slider("Секунди на хід", 10, 120, value=data.get("duration", 60))
...
# --- ГРА (DISCORD SYNC) ---
    ...
    if not data.get("explainer"):
        ...
        quotes = [
            ...
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: 4(x - 5) = 3x - 6",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: (a - 4)(a + 2) - (a - 1)²",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: 25x² - 16y²",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: 2x³ - 3x² + x, якщо x = -1",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: (x⁴)² * x³",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: x + y = 5 та 2x - y = 1",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: (-0,2)⁴ * 5⁴",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: -3a²b * 4a³b⁴",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: |x + 3| = 7",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: ax + ay + 3x + 3y",
            ...
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: (x - 3)(x + 3) = x² - 9",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: (x + 2)/3 - (x - 1)/2 = 1",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: (3m - n)² - (3m + n)²",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: Побудуйте графік функції y = 2x - 3",
            "📐 Поки чекаємо, можеш повирішувати приклади з математики Мерзляка за 7 клас: 2x² - 3x + 1 та x² + 3x - 4",
    ...
    # RERUN завжди в кінці блоку playing_sync для синхронізації гравця
